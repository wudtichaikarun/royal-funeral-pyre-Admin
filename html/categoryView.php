      ...
      <div class="row objectSearch">
        ...
        <div class="col-lg-6">
          <div class="input-group">
            <input type="text" class="form-control" placeholder="ใส่ชื่อหมวดหมู่....">
            ...
            <button  type="button" class="btn btn-info" data-toggle="modal" data-target="#addGroup">
                <i class="fa fa-plus-circle" aria-hidden="true"> เพิ่มหมวดหมู่</i>
            </button>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <table class="table table-bordered" >
            <thead>
              <tr>
                <th class="th-icon">รหัสหมวดหมู่</th>
                <th class="th-img-name">ชื่อหมวดหมู่</th>
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="form-group">
                        <label> 
                          <span class="nav-link-text">ชื่อหมวดหมู่</span>
                ...
                <div class="col-lg-6">
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="form-group">
                        <label> 
                          <span class="nav-link-text">ชื่อหมวดหมู่(ภาษาอังกฤษ)</span>
                          <i class="fa fa-fw fa-asterisk icon-topic"></i>    
                        </label>
                        <input class="form-control" >
                      </div>
                      <div class="form-group">
                        <label>รายละเอียดหมวดหมู่(ภาษาอังกฤษ)</label>
                        <textarea class="form-control" rows="3"></textarea>
                      </div>
                      <div class="form-group">
                        <label>สถานนะ</label>
