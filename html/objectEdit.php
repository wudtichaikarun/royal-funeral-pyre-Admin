...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
            ...
            <div class="card mb-3">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5">
                    <button type="button" class="btn btn-outline-primary" > จัดการข้อมูลศิลปิน </button>
                  </div>
                </div>
                ...
                <div class="form-group" id="artists">
                  <label>เพิ่มศิลปินที่สร้าง</label>
          ...
          <div class="col-lg-6">
            <div class="card mb-3">
              <div class="card-body">
                ...
                <br>
                <div class="form-group">
                  <label>เปลี่ยนรูปภาพหลักของชิ้นงาน</label>
                  <div class="input-group">
    ...
    // Show  Modal  images table  and hide videos table
    $('#showImgsTable').click(function () {
      $('#videosTable').hide();
      $('#imgsTable').show();
    })
