...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
      ...
      <div class="row objectSearch">
        ...
        <div class="col-lg-6">
          <div class="input-group">
            <input type="text" class="form-control" placeholder="ใส่ชื่อความเชี่ยวชาญ....">
            <span class="input-group-btn">
              <button class="btn btn-info" type="button">ค้นหา</button>
            </span>
            <button  type="button" class="btn btn-info" data-toggle="modal" data-target="#addSkill">
                <i class="fa fa-plus-circle" aria-hidden="true"> เพิ่มความเชี่ยวชาญ</i>
            </button>
          </div>
        </div>
      </div>
          ...
          <table class="table table-bordered" >
            <thead>
              <tr>
                ...
                <th class="th-name">ชื่อความเชี่ยวชาญ</th>
                <th class="th-name">ความเชี่ยวชาญ(ภาษาอังกฤษ)</th>
    ...
    <!-- Add Group Modal -->
    <div class="modal fade bd-example-modal-lg" id="addSkill" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">         
            <div id="imgsTable">
              <ol class="breadcrumb">
                <li class="breadcrumb-item active">ความเชี่ยวชาญ</li>
              </ol>
            </div>
            <form>
              <div class="row">
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="form-group">
                        <label> 
                          <span class="nav-link-text">ชื่อความเชี่ยวชาญ</span>
                      ...
                      <div class="form-group">
                        <label> 
                          <span class="nav-link-text">ชื่อความเชี่ยวชาญ(ภาษาอังกฤษ)</span>
                          <i class="fa fa-fw fa-asterisk icon-topic"></i>    
                        </label>
                        <input class="form-control" >
                      </div>
    ...
    <!-- Edite Group Modal -->
    <div class="modal fade bd-example-modal-lg" id="editSkill" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">
          ...
          <div class="modal-body">         
            <div id="imgsTable">
              <ol class="breadcrumb">
                <li class="breadcrumb-item active">แก้ไขความเชี่ยวชาญ</li>
              </ol>
            </div>
            <form>
              <div class="row">
